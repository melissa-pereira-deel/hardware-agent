...
Wi-Fi, Bluetooth/BLE, Zigbee, Thread and LoRa devices are classed as **restricted-radiation radiocommunication equipment**. They require ANATEL approval **before importation or sale** in Brazil.
...
2. **The applicant must be a Brazilian legal entity with a valid CNPJ.** A foreign manufacturer cannot hold the homologation directly.
